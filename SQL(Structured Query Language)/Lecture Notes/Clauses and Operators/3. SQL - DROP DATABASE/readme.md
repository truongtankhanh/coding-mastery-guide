Để xoá một bảng trong cơ sở dữ liệu bằng SQL, chúng ta sử dụng câu lệnh `DROP TABLE`. Câu lệnh này xoá hoàn toàn một bảng từ cơ sở dữ liệu cùng với tất cả các dữ liệu và cấu trúc liên quan đến bảng đó.
